...
type NavSubheaderInnerProps = { open?: boolean; children?: React.ReactNode; className?: string; [key: string]: any };

export const NavSubheader = styled(({ open, children, className, ...other }: NavSubheaderInnerProps) => (
  <ListSubheader
    disableSticky
    component="div"
    {...other}
