 ...
 * @slot root
 */
const ItemRoot = styled(ButtonBase, { shouldForwardProp })<ItemStyledProps>(({ active, open, theme }) => {
 ...
 * @slot icon
 */
const ItemIcon = styled('span', { shouldForwardProp })<ItemStyledProps>(() => ({
  ...navItemStyles.icon,
 ...
 * @slot texts
 */
const ItemTexts = styled('span', { shouldForwardProp })<ItemStyledProps>(() => ({
  ...navItemStyles.texts,
}));
 ...
 * @slot title
 */
const ItemTitle = styled('span', { shouldForwardProp })<ItemStyledProps>(({ theme }) => ({
 ...
 * @slot caption text
 */
const ItemCaptionText = styled('span', { shouldForwardProp })<ItemStyledProps>(({ theme }) => ({
 ...
 * @slot info
 */
const ItemInfo = styled('span', { shouldForwardProp })<ItemStyledProps>(() => ({
  ...navItemStyles.info,
}));
 ...
 * @slot arrow
 */
const ItemArrow = styled(Iconify, { shouldForwardProp })<ItemStyledProps>(({ theme }) => ({
