...
type Workspace = { id: string; name: string; logo: string; plan: string };

export function WorkspacesPopover({ data = [] as Workspace[], sx, ...other }: { data?: Workspace[]; sx?: any; [key: string]: any }) {
  const mediaQuery = 'sm';
