...
export function NavHorizontal({
  ...
  ...other
}: { sx?: any; data?: any; className?: string; checkPermissions?: any; layoutQuery?: Breakpoint; cssVars?: any; [key: string]: any }) {
  return (
    <Box
      ...
      sx={[
        (theme) => ({
          ...
          display: { xs: 'none', [layoutQuery as string]: 'flex' } as any,
